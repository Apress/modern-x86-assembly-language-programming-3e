...
{
    constexpr char nl = '\n';
    const char* bn_results = "@Ch12_03_Convolve1D_F32_Output";

    std::cout << "----- Results for Ch12_03 -----\n\n";
    ...
    bool rc2 = Convolve1D_F32_avx2(y2.data(), x.data(), kernel.data(),
        x.size(), kernel.size());
...
int main(void)
{
    ...
    {
        std::cout << "Ch12_03 exception: " << ex.what() << '\n';
    }
