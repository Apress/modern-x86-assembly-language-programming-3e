...
SF      equ     4                           ;scale factor for F32 elements
        ...
        global Convolve1D_Ks5_F32_avx2
Convolve1D_Ks5_F32_avx2:
...
; Initialize
        ...
        vbroadcastss ymm0,[r8]              ;ymm0 = packed kernel[0]
        vbroadcastss ymm1,[r8+4]            ;ymm1 = packed kernel[1]
        vbroadcastss ymm2,[r8+8]            ;ymm2 = packed kernel[2]
        vbroadcastss ymm3,[r8+12]           ;ymm3 = packed kernel[3]
        vbroadcastss ymm4,[r8+16]           ;ymm4 = packed kernel[4]
