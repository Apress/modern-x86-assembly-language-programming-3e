...
{
    constexpr char nl = '\n';
    const char* bn_results = "@Ch12_05_Convolve1D_Ks5_F32_Output";

    std::cout << "----- Results for Ch12_05 -----\n\n";
    ...
    bool rc2 = Convolve1D_Ks5_F32_avx2(y2.data(), x.data(), kernel.data(),
        x.size());
...
int main(void)
{
    ...
    {
        std::cout << "Ch12_05 exception: " << ex.what() << '\n';
    }
