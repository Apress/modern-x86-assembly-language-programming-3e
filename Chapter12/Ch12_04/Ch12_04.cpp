...
{
    constexpr char nl = '\n';
    const char* bn_results = "@Ch12_04_Convolve1D_F64_Output";

    std::cout << "----- Results for Ch12_04 -----\n\n";
    ...
    bool rc2 = Convolve1D_F64_avx2(y2.data(), x.data(), kernel.data(), x.size(), kernel.size());
...
int main(void)
{
    ...
    {
        std::cout << "Ch12_04 exception: " << ex.what() << '\n';
    }
