...
{
    constexpr char nl = '\n';
    const char* bn_results = "@Ch12_06_Convolve1D_Ks5_F64_Output";

    std::cout << "----- Results for Ch12_06 -----\n\n";
    ...
    bool rc2 = Convolve1D_Ks5_F64_avx2(y2.data(), x.data(), kernel.data(),
        x.size());
...
int main(void)
{
    ...
    {
        std::cout << "Ch12_06 exception: " << ex.what() << '\n';
    }
