...
private:
    template <typename T> std::string ToStringInt(const T* x, size_t n, size_t w)
    {
        std::ostringstream oss;

        for (size_t i = 0; i < n; i++)
        {
            oss << std::setw((int)w) << (int64_t)x[i];
    ...
    template <typename T> std::string ToStringUint(const T* x, size_t n, size_t w)
    {
        std::ostringstream oss;

        for (size_t i = 0; i < n; i++)
        {
            oss << std::setw((int)w) << (uint64_t)x[i];
    ...
    template <typename T> std::string ToStringHex(const T* x, size_t n, size_t w)
    {
        std::ostringstream oss;
    ...
    template <typename T> std::string ToStringFP(const T* x, size_t n, size_t w, int p)
    {
        std::ostringstream oss;
