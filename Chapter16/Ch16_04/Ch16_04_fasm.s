...
NSE     equ 4                           ;num_simd_elements
        ...
        global VecCrossProducts_avx2
VecCrossProducts_avx2:
        push r12
        push r13
        push r14
        push r15
...
; Note: VecCrossProductsNT_avx2() uses vmovntpd instead of vmovapd
        vmovapd [r9+rax*8],ymm8             ;save c.X[i:i+NSE-1]
...
; Note: VecCrossProductsNT_avx2() uses vmovntpd instead of vmovapd
        vmovapd [rcx+rax*8],ymm8            ;save c.Y[i:i+NSE-1]
...
; Note: VecCrossProductsNT_avx2() uses vmovntpd instead of vmovapd
        vmovapd [rdx+rax*8],ymm8            ;save c.Z[i:i+NSE-1]
