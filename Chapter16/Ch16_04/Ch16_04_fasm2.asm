...
NSE     equ 4                           ;num_simd_elements
        ...
        .code
VecCrossProductsNT_avx2 proc frame
        CreateFrame_M AB_,0,48,r12,r13,r14,r15
