...
SF      equ     4                           ;scale factor for F32 elements
       ...
       section .text
        ...
        global Convolve1D_Ks5_F32_avx512
Convolve1D_Ks5_F32_avx512:
...
; Initialize
        ...
        vbroadcastss zmm0,[r8]                  ;zmm0 = packed kernel[0]
        vbroadcastss zmm1,[r8+4]                ;zmm1 = packed kernel[1]
        vbroadcastss zmm2,[r8+8]                ;zmm2 = packed kernel[2]
        vbroadcastss zmm3,[r8+12]               ;zmm3 = packed kernel[3]
        vbroadcastss zmm4,[r8+16]               ;zmm4 = packed kernel[4]
...
Loop4:  lea r11,[rax+KS2]                       ;k = i + KS2
        ...
        vmulss xmm5,xmm0,[rdx+r11*SF]           ;kernel[0] * x[k]
        ...
        vmovss [rcx+rax*SF],xmm5                ;save y[i]
        inc rax                                 ;i += 1
