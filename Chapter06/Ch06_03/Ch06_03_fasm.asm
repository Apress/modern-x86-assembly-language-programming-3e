...
;------------------------------------------------------------------------------
; bool CalcConeAreaVol_A(const double* r, const double* h, int n,
...
F64_3p0     real8 3.0
        ...
        .code
CalcConeAreaVol_avx proc frame
...
; use of the non-volatile GP and XMM registers.
        ...
        vmovsd xmm14,real8 ptr [g_F64_PI]   ;xmm14 = pi
        vmovsd xmm15,real8 ptr [F64_3p0]    ;xmm15 = 3.0
