...
SF          equ 4                           ;scale factor for F32 elements
        ...
        .code
MatrixMulF32_avx512 proc frame
...
; Calculate c[i][j:j+NSE-1]
        align 16
Loop3a: vbroadcastss zmm0,real4 ptr [rbx]       ;broadcast a[i][k]
...
; Calculate c[i][j:j+NRC] (NRC is num_residual_cols)
        align 16
Loop3b: vbroadcastss zmm0,real4 ptr [rbx]       ;broadcast a[i][k]
