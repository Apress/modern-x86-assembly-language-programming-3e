...
void InitData(MatrixF32& m, Vec4x1_F32* va, size_t num_vec)
{
    if (m.GetNumRows() != 4 || m.GetNumCols() != 4)
        throw std::runtime_error("InitData() - invalid matrix size");

    constexpr float a_row0[] = { 10.0, 11.0, 12.0, 13.0 };
    constexpr float a_row1[] = { 20.0, 21.0, 22.0, 23.0 };
    constexpr float a_row2[] = { 30.0, 31.0, 32.0, 33.0 };
    constexpr float a_row3[] = { 40.0, 41.0, 42.0, 43.0 };
